...
function Car(brand, model, year, mileage, fuelType, speed) {
  ...
  console.log("Екземпляр об'єкту: Car");
...
function Truck(
  ...
  //  Записуєм в this.color значення аргументу color, в this.engineType значення аргументу engineType і так далі зі всіми аргументам
  Vehicle.call(this, brand, model, year, mileage);
  this.color = color;
...
console.log("Екземпляр об'єкту: Truck");
...
const carWithDrive = new Car("BMW", "X5", 2022, 1500, "Petrol", 0);
const driveFunction = carWithDrive.drive.bind(carWithDrive);
driveFunction(100);
...
function ElectricCar(brand, model, year, mileage, batteryCapacity) {
  ...
  console.log("Екземпляр об'єкту: ElectricCar");
